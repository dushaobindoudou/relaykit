/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 3bf4214e2e86f6bc75886a0e47579204)
// Runtime types generated with workerd@1.20260910.1 2025-09-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	MEDIA: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	RELAYKIT_ENV: "production";
	ADMIN_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RELAYKIT_ENV" | "ADMIN_TOKEN" | "POLYGON_ADDRESS" | "BSC_ADDRESS">> {}
}
