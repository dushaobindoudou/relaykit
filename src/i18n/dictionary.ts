...
export const en = {
  ...
  home: {
    ...
    heroPoint2: "USDT on Polygon & BSC, plus Alipay / WeChat",
    ...
    howStep2: "Pay with USDT (Polygon / BSC) or by Alipay / WeChat transfer.",
